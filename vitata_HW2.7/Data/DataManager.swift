...
class DataManager {
    ...
    var firstNameList = ["Albert", "Nicola", "Isaac", "Michael",
                         "Alfred", "Thomas", "Charles", "Sigmund",
                         "Niels", "Georg"]
    
    var lastNameList = ["Eintstein", "Tesla", "Newton", "Faraday",
                        "Nobel", "Edison", "Darwin", "Freud",
                        "Bohr", "Ohm"]
    
    var emailList = ["Albert.Eintstein@yahoo.com", "nicola.tesla@gmail.com",
    ...
    var phoneList = ["(911)1234567", "(912)2345678", "(913)3456789", "(914)4567890",
